...
<body>
    ...
    <section class="d-flex align-items-center justify-content-center" style="height: 85vh;background-color:lightblue;">
        <div class="card" style="width: 42%">
            ...
            <div class="card-body">
                ...
                <div class="m-3">
                    <a href="kuis.php" class="btn btn-info" style="float:right">Mulai Mengerjakan Kuis!</a>
                </div>
            </div>
        </div>
    </section>
